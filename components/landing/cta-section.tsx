    ...
    <section className="py-24 bg-linear-to-b from-[#1A1D24] from-1% via-[#27c79242] via-98% to-[#1A1D24]">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">Start monitoring in minutes</h2>
          <p className="text-muted-foreground mb-8">Free 14-day trial. No credit card required.</p>
